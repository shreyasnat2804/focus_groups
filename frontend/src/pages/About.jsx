  ...
  return (
    <div className="about-page">
      ...
      <p className="about-lead">
        ...
        diverse feedback on your product ideas — without the cost and delays of
      ...
      <section className="about-section">
        ...
        <ol className="about-steps">
          <li>
            ...
            a sector (Tech, Financial, or Political).
          </li>
          <li>
            <strong>We build your panel</strong> — Our system selects diverse
            personas from a pool of real demographic data, ensuring a mix of
            ages, genders, income levels, and backgrounds.
          </li>
          <li>
            <strong>Get instant feedback</strong> — Each persona responds to your
            pitch in their own voice and style, just like a real focus group
            participant would.
          </li>
          <li>
          ...
          <li>
            <strong>Export and share</strong> — Download your results as CSV or
      ...
      <section className="about-section">
        ...
        <ul className="about-list">
          ...
          <li>CSV and PDF exports for easy sharing</li>
        </ul>
      </section>
